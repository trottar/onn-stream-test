...
**Status:** Accepted decision (2026-09-20) — **CLOSED 2026-09-23: BASELINE
MET**, Phase C resumed. The pre-registered close-out
(`evidence/D_BASE_CLOSEOUT_2026-09-23.md`) scored the table cold and warm
on the adopted build (cap 90 KB, cushion 12/17, redundancy 2/4): spikes
32.8 / 26.0 per min, fps 59.90 / 59.91, stale 1.1 / 0.8, video loss
8.7 / 8.4, audio underruns 17 / 14 per session; max output gap 163 / 110
ms, the transport's open row. **The client decision below is NOT
triggered** — the onn is not the ceiling.
