...
| --- | --- | --- |
| Windows-specific native server/capture/audio/input stack | Expected prototype debt | Phase D Linux functional migration |
| Representative Linux resource/transport sizing not yet measured | Planned | Phase E after Linux baseline |
...
| WGC/FFmpeg/process-audio clean-machine bootstrap not fully represented | Portability/reproducibility debt | Phase D or earlier clean-machine requirement |
...
| Remaining Live TV/EPG/guide identity and UX work | Planned product debt | Phase F |
| VOD recursive artwork/metadata cache polish | Planned product debt | Phase F |
